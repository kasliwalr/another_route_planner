...
private:
    ...
    void DrawRoutes(io2d::output_surface &surface) const;
    void DrawLocations(io2d::output_surface &surface) const;
    ...
    //rk: added route attributes - brush color and route width 
    io2d::brush m_RouteBrush{io2d::rgba_color{255,0,0}};
    float m_RouteWidth = 6.f;
    
    io2d::brush m_LocationBrush{io2d::rgba_color{0,255,0}};
    float m_LocationWidth = 8.f;
